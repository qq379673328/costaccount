// 区域级任务-任务列表
app.controller('JobzoneListCtrl',function($scope,
	...
	$scope.tableParams = new ngTableParams({
		...
		getData: function($defer, params) {
			...
			$http.post("jobzone/list", $scope.queryParams).success(function(data){
	...
	$scope.del = function(item){
		item.ishanding = true;
		$http.post("jobzone/del/" + item.id).success(function(data){
			$scope.reload();
		}).error(function(){
