//列表
app.controller('OrgListCtrl',function($scope,
	...
	$scope.tableParams = new ngTableParams({
		...
		getData: function($defer, params) {
			...
			$http.post("org/list", $scope.queryParams).success(function(data){
	...
	$scope.del = function(item){
		item.ishanding = true;
		$http.post("org/delById", {id: item.ID}).success(function(data){
			$scope.reload();
		}).error(function(){
